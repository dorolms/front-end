...
const items: Item[] = [
  ...
  {
    href: "/manager/lectures",
    label: "강의 관리",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24">
        <path
          fill="currentColor"
          d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14l-4-4H5a2 2 0 0 1-2-2z"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24">
        <path
          fill="currentColor"
          d="M12 12a5 5 0 1 0-5-5a5 5 0 0 0 5 5m0 2c-3.33 0-10 1.67-10 5v3h20v-3c0-3.33-6.67-5-10-5z"
        />
      </svg>
    ),
  },
...
/* styled-components — InstructorSidebar와 동일 */
